...
from train_CLIP import train_clip_model
...
train_loader, train_dataset = load_split(train_json_path, "train", image_folder_path, tokenizer, preprocess, batch_size)
...
_, test_dataset = load_split(test_json_path, "test", image_folder_path, tokenizer, preprocess, batch_size, subset_size=None)
